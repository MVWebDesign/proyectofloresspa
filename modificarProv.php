...
?>
<?php 
$ver = mysqli_query($conexion, "SELECT * FROM tproveedores WHERE id = ".$_REQUEST['id']." ");
...
<head>
    ...
    <title>Actualización del Proveedor</title>
...
<body>
    <nav class="topnav" id="myTopnav">
        <a href="regProveedores.php">Registro Proveedor</a>
    ...
    <div class="registration-form">
        <form action="actualizarProv.php" method="post">
            ...
            <div class="form-group">
                ...
                value="<?php if(isset($conexion['Nombre'])): echo $conexion['Nombre']; endif; ?>" 
                title="Nombre(s)">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$" maxlength="30" name="apellido"
                value="<?php if(isset($conexion['Apellido'])): echo $conexion['Apellido']; endif; ?>" 
                title="Apellido(s)">
            </div>
            <div class="form-group">
                ...
                value="<?php if(isset($conexion['Telefono'])): echo $conexion['Telefono']; endif; ?>" 
                title="Teléfono">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$" maxlength="30" name="direccion"
                value="<?php if(isset($conexion['Direccion'])): echo $conexion['Direccion']; endif; ?>" 
                title="Apellido(s)">
            </div>
            <div class="form-group">
                <input type="email" class="form-control item" pattern="^[a-zA-ZÀ-ÿ0-9_\u00f1\u00d1]+([.][a-zA-ZñÑ0-9_]+)*@[a-zA-ZñÑ0-9_]+([.][a-zA-ZñÑ0-9_]+)*[.][a-zA-Z]{1,5}" maxlength="40" name="correo"
                value="<?php if(isset($conexion['Correo'])): echo $conexion['Correo']; endif; ?>" 
                title="Correo">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1]+$" maxlength="30" name="empresa"
                value="<?php if(isset($conexion['Empresa'])): echo $conexion['Empresa']; endif; ?>" 
                title="Apellido(s)">
            </div>
            <div class="form-group">
