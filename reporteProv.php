...
function Header(){
    ...
    $this->Ln(10);
    $this->Cell(170,60,utf8_decode('Reporte de Proveedores'),0,0,'R');
    ...
    $this->Cell(65, 10,utf8_decode('Nombres'), 1, 0, 'C', 0);
    $this->Cell(65, 10,utf8_decode('Apellidos'), 1, 0, 'C', 0);
    $this->Cell(30, 10,utf8_decode('Teléfono'), 1, 0, 'C', 0);
    $this->Cell(50, 10,utf8_decode('Dirección'), 1, 0, 'C', 0);
    $this->Cell(50, 10, 'Correo', 1, 0, 'C', 0);
    $this->Cell(20, 10,utf8_decode('Empresa'), 1, 0, 'C', 0);
    $this->Ln(10);
}
// Pie de página
function Footer(){
